...
app.get('/addmedianew',function(req,resp){
   // var o_id = new mongodb.ObjectID('5be5754b5b3a1f0b6b89fdd0');
//db.collection('media').update({ id: o_id}, {$set: {name: 'artistxp_insta_19' image: 'artistxpinsta019.jpg'}},{multi:true});
  /*  db.collection('media').insert([{
        name: 'artistxp_insta_20',
        noofclick: 0,
        image: 'artistxpinsta020.jpg',
        type: 6,
        status: 0,
        sponsor: '',
        sortindex: 0
...
app.get('/bannertestlist',function(req,resp){
    var collection= db.collection('media');
...
app.get('/cngstatusbannertest',function(req,resp){
    var collection= db.collection('media');
    var o_id = new mongodb.ObjectID(req.query._id);
...
app.get('/deletebannertest',function(req,resp){
    var collection= db.collection('media');
    var o_id = new mongodb.ObjectID(req.query._id);
